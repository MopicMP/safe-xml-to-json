...
> Safe convert xml to json and back

[![PyPI version](https://badge.fury.io/py/safe-xml-to-json.svg)](https://pypi.org/project/safe-xml-to-json/)
...
```bash
pip install safe-xml-to-json
```

## Quick Start

```python
from safe_xml_to_json import json
...
from safe_xml_to_json import batch
